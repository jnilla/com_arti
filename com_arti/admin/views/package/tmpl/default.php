...
$id = $this->item->id;
// // DEBUG >>>
// ob_start(); var_dump( $this->id);        $phpdump = ob_get_clean(); $phptrace = '<span style=\'color:purple\'>'.str_replace(@JPATH_ROOT, '.', dirname(__FILE__)).'/<strong>'.basename(__FILE__).'</strong></span><span style=\'color:green\'>:'.__LINE__.'</span> cs:<span style=\'color:blue\'>'.@__CLASS__.'</span> fn:<span style=\'color:red\'>'.__FUNCTION__.'()</span>'; echo "<pre>PDD &gt;&gt;&gt;:\n$phptrace\nDUMP:\n$phpdump\n &lt;&lt;&lt; PDD</pre>";
// die;
// // <<< DEBUG 
?>
    ...
    <div class="accordion" id="commands-accordion">
            ...
            <div id="commands-accordion-accordion-1" class="accordion-body collapse">
                <div class="accordion-inner">
                    <div class="control-group">
                        <a href="<?php echo "index.php?option=com_arti&view=package&task=package.initializepackage&id=$id"; ?>" class="btn btn-info"><i class="icon-play-circle"></i> <?php echo Jom::translate('COM_ARTI_BUTTON_INITIALIZE'); ?></a>
                    </div>    
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div id="commands-accordion-accordion-2" class="accordion-body collapse">
                <div class="accordion-inner">
                    <div class="control-group">
                        <a href="<?php echo "index.php?option=com_arti&view=package&task=package.buildpackage&id=$id"; ?>" class="btn btn-primary"><i class="icon-play-circle"></i> <?php echo Jom::translate('COM_ARTI_BUTTON_BUILD'); ?></a>
                    </div>    
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div id="commands-accordion-accordion-3" class="accordion-body collapse">
                <div class="accordion-inner">
                    ...
                    <div class="control-group">
                        <a href="" class="btn btn-success"><i class="icon-play-circle"></i> <?php echo Jom::translate('COM_ARTI_BUTTON_CREATE'); ?></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#commands-accordion" href="#commands-accordion-accordion-4">
                    <?php echo Jom::translate('COM_ARTI_HEADING_CREATE_FIELDS'); ?>
                </a>
            </div>
            <div id="commands-accordion-accordion-4" class="accordion-body collapse">
                <div class="accordion-inner">
                    ...
                    ?>
                    <?php echo Jom::renderFieldOnce($form, 'new_form_fields'); ?>
                    <div class="control-group">
                        <a href="" class="btn btn-success"><i class="icon-play-circle"></i> <?php echo Jom::translate('COM_ARTI_BUTTON_CREATE'); ?></a>
                    </div>
                </div>
